  ...
  async function generate() {
    try {
      ...
      for (let i = 0; i < book.pageCount; i++) {
        ...
        const data = await res.json()
        if (!res.ok || !data.imageUrl) { imgs.push(null); continue }
      ...
      {phase === 'reading' && pages.length > 0 && (
        <div style={{ flex: 1, display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
          ...
          <div style={{
            ...
            {/* Back */}
            <button
              onClick={() => { stopCurrent(); router.push('/zone/elephant') }}
              style={{
            ...
            {/* Title */}
            <p style={{
              color: '#FFF8E7', fontWeight: 700, fontSize: 18, margin: 0, textAlign: 'center',
              textShadow: '0 2px 8px rgba(0,0,0,0.3)',
            ...
            {/* Page counter */}
            <p style={{
              color: 'rgba(255,248,231,0.8)', fontSize: 14, fontWeight: 400, margin: 0,
                  ...
                  : <motion.div
                    ...
                    >
                      <p style={{ color: 'rgba(255,255,255,0.85)', fontSize: 16,
                        fontFamily: F, fontWeight: 400, textAlign: 'center', padding: '0 16px' }}>
                        Painting this page...
                      </p>
                    </motion.div>
                }
              ...
              <AnimatePresence mode="wait">
                <motion.p
                  ...
                  style={{
                    ...
                    fontSize: textSize, fontFamily: F, fontWeight: 500,
                    textAlign: 'center',
                  }}
                >
                  {pages[pageIdx]?.text ?? ''}
